...
public class CoreWorkload extends Workload {
	...
	private static final String ELEMENTCONTAINSSENTENCE_PROPORTION_PROPERTY = "elementContainsSentenceproportion";

	private static final String ELEMENTCONTAINSSENTENCE_PROPORTION_PROPERTY_DEFAULT = "0.0";

	private static final String SEARCHENTRYCONTAININGSENTENCE_PROPORTION_PROPERTY = "searchEntryContainingSentenceproportion";

	private static final String SEARCHENTRYCONTAININGSENTENCE_PROPORTION_PROPERTY_DEFAULT = "0.0";

	private static final String INCR_PROPORTION_PROPERTY = "incrproportion";

	private static final String INCR_PROPORTION_PROPERTY_DEFAULT = "0.0";

	private static final String SUM_PROPORTION_PROPERTY = "sumproportion";

	private static final String SUM_PROPORTION_PROPERTY_DEFAULT = "0.0";

	private static final String SUMALL_PROPORTION_PROPERTY = "sumAllproportion";

	private static final String SUMALL_PROPORTION_PROPERTY_DEFAULT = "0.0";

	private static final String MULTCONST_PROPORTION_PROPERTY = "multConstproportion";

	private static final String MULTCONST_PROPORTION_PROPERTY_DEFAULT = "0.0";

	private static final String MULT_PROPORTION_PROPERTY = "multproportion";

	private static final String MULT_PROPORTION_PROPERTY_DEFAULT = "0.0";

	private static final String MULTALL_PROPORTION_PROPERTY = "multAllproportion";

	private static final String MULTALL_PROPORTION_PROPERTY_DEFAULT = "0.0";

	private static final String SEARCHELEMENT_PROPORTION_PROPERTY = "searchElementproportion";

	private static final String SEARCHELEMENT_PROPORTION_PROPERTY_DEFAULT = "0.0";

	private static final String SEARCHENTRY_PROPORTION_PROPERTY = "searchEntryproportion";

	private static final String SEARCHENTRY_PROPORTION_PROPERTY_DEFAULT = "0.0";

	private static final String ORDERENTRYS_PROPORTION_PROPERTY = "orderEntrysproportion";

	private static final String ORDERENTRYS_PROPORTION_PROPERTY_DEFAULT = "0.0";

	private static final String SEARCHGREATERTHAN_PROPORTION_PROPERTY = "searchGreaterThanproportion";

	private static final String SEARCHGREATERTHAN_PROPORTION_PROPERTY_DEFAULT = "0.0";

	private static final String SEARCHLESSERTHAN_PROPORTION_PROPERTY = "searchLesserThanproportion";

	private static final String SEARCHLESSERTHAN_PROPORTION_PROPERTY_DEFAULT = "0.0";

	private static final String VALUEGREATERTHAN_PROPORTION_PROPERTY = "valuegreaterThanproportion";

	private static final String VALUEGREATERTHAN_PROPORTION_PROPERTY_DEFAULT = "0.0";
	...
	protected static DiscreteGenerator createOperationGenerator(final Properties p) {
		...
		final double elementContainsSentenceproportion = Double.parseDouble(p.getProperty(
				ELEMENTCONTAINSSENTENCE_PROPORTION_PROPERTY, ELEMENTCONTAINSSENTENCE_PROPORTION_PROPERTY_DEFAULT));

		final double searchEntryContainingSentenceproportion = Double.parseDouble(p.getProperty(
				SEARCHENTRYCONTAININGSENTENCE_PROPORTION_PROPERTY, SEARCHENTRYCONTAININGSENTENCE_PROPORTION_PROPERTY_DEFAULT));

		final double incrproportion = Double.parseDouble(p.getProperty(
				INCR_PROPORTION_PROPERTY, INCR_PROPORTION_PROPERTY_DEFAULT));

		final double sumproportion = Double.parseDouble(p.getProperty(
				SUM_PROPORTION_PROPERTY, SUM_PROPORTION_PROPERTY_DEFAULT));

		final double sumAllproportion = Double.parseDouble(p.getProperty(
				SUMALL_PROPORTION_PROPERTY, SUMALL_PROPORTION_PROPERTY_DEFAULT));

		final double multConstproportion = Double.parseDouble(p.getProperty(
				MULTCONST_PROPORTION_PROPERTY, MULTCONST_PROPORTION_PROPERTY_DEFAULT));

		final double multproportion = Double.parseDouble(p.getProperty(
				MULT_PROPORTION_PROPERTY, MULT_PROPORTION_PROPERTY_DEFAULT));

		final double multAllproportion = Double.parseDouble(p.getProperty(
				MULTALL_PROPORTION_PROPERTY, MULTALL_PROPORTION_PROPERTY_DEFAULT));

		final double searchElementproportion = Double.parseDouble(p.getProperty(
				SEARCHELEMENT_PROPORTION_PROPERTY, SEARCHELEMENT_PROPORTION_PROPERTY_DEFAULT));

		final double searchEntryproportion = Double.parseDouble(p.getProperty(
				SEARCHENTRY_PROPORTION_PROPERTY, SEARCHENTRY_PROPORTION_PROPERTY_DEFAULT));

		final double orderEntrysproportion = Double.parseDouble(p.getProperty(
				ORDERENTRYS_PROPORTION_PROPERTY, ORDERENTRYS_PROPORTION_PROPERTY_DEFAULT));

		final double searchGreaterThanproportion = Double.parseDouble(p.getProperty(
				SEARCHGREATERTHAN_PROPORTION_PROPERTY, SEARCHGREATERTHAN_PROPORTION_PROPERTY_DEFAULT));

		final double searchLesserThanproportion = Double.parseDouble(p.getProperty(
				SEARCHLESSERTHAN_PROPORTION_PROPERTY, SEARCHLESSERTHAN_PROPORTION_PROPERTY_DEFAULT));

		final double valuegreaterThanproportion = Double.parseDouble(p.getProperty(
				VALUEGREATERTHAN_PROPORTION_PROPERTY, VALUEGREATERTHAN_PROPORTION_PROPERTY_DEFAULT));
		...
		if (elementContainsSentenceproportion > 0) {
			operationchooser.addValue(elementContainsSentenceproportion, "ELEMENTCONTAINSSENTENCE");
		}

		if (searchEntryContainingSentenceproportion > 0) {
			operationchooser.addValue(searchEntryContainingSentenceproportion, "SEARCHENTRYCONTAININGSENTENCEP");
		}
		...
		if (sumAllproportion > 0) {
			operationchooser.addValue(sumAllproportion, "SUMALL");
		}

		if (multConstproportion > 0) {
			operationchooser.addValue(multConstproportion, "MULTCONST");
		}

		if (multproportion > 0) {
			operationchooser.addValue(multproportion, "MULT");
		}

		if (multAllproportion > 0) {
			operationchooser.addValue(multAllproportion, "MULTALL");
		}

		if (searchElementproportion > 0) {
			operationchooser.addValue(searchElementproportion, "SEARCHELEMENT");
		}

		if (searchEntryproportion > 0) {
			operationchooser.addValue(searchEntryproportion, "SEARCHENTRY");
		}

		if (orderEntrysproportion > 0) {
			operationchooser.addValue(orderEntrysproportion, "ORDERENTRYS");
		}

		if (searchGreaterThanproportion > 0) {
			operationchooser.addValue(searchGreaterThanproportion, "SEARCHGREATERTHAN");
		}

		if (searchLesserThanproportion > 0) {
			operationchooser.addValue(searchLesserThanproportion, "SEARCHLESSERTHAN");
		}

		if (valuegreaterThanproportion > 0) {
			operationchooser.addValue(valuegreaterThanproportion, "VALUEGREATERTHAN");
		}
